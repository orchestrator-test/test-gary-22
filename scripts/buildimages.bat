...
echo "building image testgary22-buildstage"
pushd source
%CONTAINER_RUNTIME% build -f Dockerfile.buildstage -t testgary22-buildstage .
popd

echo "building image testgary22"
pushd source
%CONTAINER_RUNTIME% build -f Dockerfile -t testgary22 .
popd
