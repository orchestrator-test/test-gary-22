...
echo "pushing image testgary22"
%CONTAINER_RUNTIME% tag testgary22 %REGISTRY_URL%/%REGISTRY_NAMESPACE%/testgary22
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/testgary22

echo "pushing image testgary22-buildstage"
%CONTAINER_RUNTIME% tag testgary22-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/testgary22-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/testgary22-buildstage
